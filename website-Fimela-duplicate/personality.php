		...
		<div class="row">
			<div class="tile1">
				<div class="col">
					<?php
                include "koneksi.php";
                 $tampil_berita_cerita = $conn->query("SELECT * FROM tb_personality");
                ...
                <p></p>
					<div class="media">
						...
						<div class="media-body"><font class="font-tag">Lifestyle</font>
							<br>	<a href="#"><h5 class="font-konten"><?php echo $data['judul_personality'];?></h5></a>
							<p class="font-sub"><?php echo $data['isi_personality'];?></p>
						</div>
					</div>
					<?php } ?>
				</div>
	...
	<div class="container">
		<div class="center">
			...
			<div class="tile1">
				<div class="col">
					<?php
                include "koneksi.php";
                 $tampil_berita_cerita = $conn->query("SELECT * FROM tb_personality2");
                while($data = mysqli_fetch_array($tampil_berita_cerita)){
                ?>
                <p></p>
					<div class="media">
						...
						<div class="media-body"><font class="font-tag">Lifestyle</font>
							<br>	<a href="#"><h5 class="font-konten"><?php echo $data['judul_personality'];?></h5></a>
							<p class="font-sub"><?php echo $data['ket_personality'];?></p>
						</div>
					</div>
					<?php } ?>
				</div>
		...
		<div class="container">
			<div class="center">
				<?php
                include "koneksi.php";
                 $tampil_berita_cerita = $conn->query("SELECT * FROM tb_personality3");
                while($data = mysqli_fetch_array($tampil_berita_cerita)){
                ?>
                <p></p>
					<div class="media">
