    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">MaduraShop</a>
            </div>
...
<br><br><br><br>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="jumbotron">
                  <h1>MaduraShop <img src="../assets/img/keranjang.png" width="20%" height="20%"></h1>
                  <p>
                    Belanja barang impian anda secara online, aman dan nyaman di MaduraShop.
                  </p><br><br><br>
                  <p>
    ...
    <div class="col-md-12 end-box ">
        &copy; 2018 | &nbsp; All Rights Reserved | MaduraShop
    </div>
    <!-- /.col -->
    <!--Footer end -->
    <!--jQUERY FILES-->
