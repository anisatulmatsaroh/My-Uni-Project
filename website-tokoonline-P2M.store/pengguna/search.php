    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Alibaba Shop</a>
            </div>
...
<br><br><br><br>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="jumbotron">
                  <h1>Alibaba Shop <img src="../assets/img/keranjang.png" width="20%" height="20%"></h1>
                  <p>
                    Belanja barang impian anda secara online, aman dan nyaman di Alibaba Shop.
                  </p><br><br><br>
                  <p>
            ...
            <center>
                ...
                <div class="row">
                    ...
                    $q2 = "select * from barang where nama_barang like '%$cari%'";
    ...
    <div class="col-md-12 end-box ">
        &copy; 2018 | &nbsp; All Rights Reserved | Alibaba Shop
    </div>
    <!-- /.col -->
    <!--Footer end -->
    <!--jQUERY FILES-->
