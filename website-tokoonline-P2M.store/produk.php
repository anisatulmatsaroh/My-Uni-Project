	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Produk</h2>
...
<!---->
    	...
    	<div class="container">	
			...
			<!-- start Clients List -->	
			<div class="Produk">
				<div class="slides produk">
				<li><img src="image/instan.png" alt="produk"/></li>
				<h2><a href="detailproduk.php">Jilbab Segi Empat BELLA SQUARE</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Jilbab Diamond Scarf</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Jilbab Pashmina Instan Raisya</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Gamis Venice Baby terry motif etnik</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Baju Gamis Motif Bunga</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Baju Gamis</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Handsock</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Handsock Pita</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Kaos Kaki Polkadot</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Kaos Kaki Polos</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Kaos Kaki Wudhu</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Ciput Rajut</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Ciput Rajut Polos</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Gantungan Kunci Unyu</a></h2>
				<div class="slides produk">
				<h2><a href="detailproduk.php">Gantungan Kunci Muslimah</a></h2>
			</div>
			<!-- end Clients List -->
